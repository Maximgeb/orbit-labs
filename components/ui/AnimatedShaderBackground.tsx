      ...
      fragmentShader: `
        ...
        void main() {
          ...
          for (float i = 0.0; i < 35.0; i++) {
            ...
            /* Orbit Labs palette — warm orange · deep navy · off-white */
            vec4 auroraColors = vec4(
              0.80 + 0.20 * sin(i * 0.20 + iTime * 0.4),   /* R — orange warm */
              0.18 + 0.12 * cos(i * 0.30 + iTime * 0.5),   /* G — muted */
              0.04 + 0.06 * sin(i * 0.40 + iTime * 0.3),   /* B — near-black */
              1.0
            );
          ...
          gl_FragColor = vec4(o.rgb * 0.70, o.a * 0.85);
        }
      `,
      transparent: true,
    })
